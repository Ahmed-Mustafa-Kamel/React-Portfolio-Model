...
const Experience = () => {
  return (
    <div className="border-b border-neutral-900 p-4">
        {/* section title */}
        <h2 className=" my-20 text-center text-4xl">Experiense</h2>
        {/*  */}
          ...
          <div key={index} className=" mb-8 flex flex-wrap lg:justify-center">
            ...
            <div className=" w-full max-w-xl lg:w-3/4">
              ...
              {experience.technologies.map((tech, index) => (
                <span key={index} className=" mt-2 mr-4 rounded bg-neutral-900 px-2 py-1 text-sm font-medium text-purple-800">{tech}</span>
              ))}
            </div>
